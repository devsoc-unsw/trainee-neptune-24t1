    ...
    <>
      ...
      <div ref={scrollTarget}>
        ...
        {events.map((event, index) => (
          <div key={index} className="flex flex-col sm:flex-row w-4/5 sm:h-60 my-2 p-2 bg-gray-100 dark:bg-slate-700 rounded-lg font-raleway transition duration-200">
