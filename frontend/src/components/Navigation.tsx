...
function NavigationBar () {
  return (
    <>
      <nav className="z-20 sticky top-0 bg-puzzleBlue transition duration-500 opacity-90 hover:opacity-100 m-0 min-w-full h-14 flex justify-evenly items-center font-raleway text-white">
        <div>
          <Link to="/">
